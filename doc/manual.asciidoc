...
Ubuntu 11.10:
--------------------------
sudo apt-get install git-core build-essential intltool libtool libgtkglext1-dev libgtkmm-2.4-dev gtk2-engines-pixbuf freeglut3-dev libxml++ libcairomm
--------------------------

Ubuntu 11.04:
--------------------------
sudo apt-get install git-core build-essential intltool libtool libgtkglext1-dev libgtkmm-2.4-dev libglut3-dev libxml++ libcairomm
--------------------------

Ubuntu 10.10:
--------------------------
sudo apt-get install git-core build-essential automake intltool libtool libgtkmm-2.4-dev libgtkglext1-dev libglut3-dev libxml++ libcairomm
--------------------------

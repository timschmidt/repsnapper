...
int Object::loadBinarySTL(string filename) {
 ...
 * Returns 0 on success and -1 on failure */
int Object::loadASCIISTL(string filename) {
...
filetype_t Object::getFileType(string filename) {
...
int Object::load(string filename)
{
...
void Object::Scale(double in_scale_factor)
{
...
void Object::RotateObject(Vector3d axis, double angle)
{
	Vector3d min,max;
...
void Object::CalcCuttingPlane(const Matrix4d &T, 
...
void Object::draw(const Model *model, const Settings &settings) const 
{
  //cerr << "Object::draw" <<  endl;
	// polygons
...
// void Object::displayInfillOld(const Settings &settings, CuttingPlane &plane,
...
//   //cerr << "Object::displayInfillOld" <<  endl;
...
void Object::draw_geometry() const
{

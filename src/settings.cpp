...
#undef FLOAT_PHASE_MEMBER
  ...
  FLOAT_MEMBER (Slicing.AntioozeRepushRatio, "AntioozeRepushRatio", 0.8, true),
  ...
  FLOAT_MEMBER  (Slicing.SupportExtrusion, "SupportExtrusion", 0.5, false),
  ...
  BOOL_MEMBER   (Slicing.SolidTopAndBottom, "SolidTopAndBottom", true, true),
...
static struct {
  ...
  { "Slicing.AntioozeRepushRatio", 0.0, 1.0, 0.01, 0.1 },
